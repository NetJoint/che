 ...
 * @author Igor Vinokur
 */
public class FileChangedNode extends AbstractTreeNode implements HasPresentation, HasAction {
     ...
     */
    public FileChangedNode(String name, String state, NodesResources nodesResources) {
        this.name = name;
        this.state = state;
